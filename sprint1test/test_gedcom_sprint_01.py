...
class TestCheckFunctionsSprint01(unittest.TestCase):
    def test_check_date_b4_current(self):
        ...
        test_case_01_1_expected = ['ERROR: FAMILY: US01: @F2@: Divorced Date 2020-06-22 occurs before today: 2019-05-09']
    ...
    def test_check_marr_b4_div(self):
        ...
        test_case_04_2 = Gedcom("sprint1test/test_example_04_2")
        ...
        test_case_04_3 = Gedcom("sprint1test/test_example_04_3")
        ...
        test_case_04_4 = Gedcom("sprint1test/test_example_04_4")
