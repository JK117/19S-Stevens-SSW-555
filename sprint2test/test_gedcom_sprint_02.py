...
class TestCheckFunctionsSprint02(unittest.TestCase):
    ...
    def test_check_birth_b4_death_of_parents(self):
        test_case_09_1 = Gedcom("test_example_15_1")
        ...
        test_case_09_2 = Gedcom("test_example_15_2")
    ...
    def test_check_marriage_after_14(self):
        test_case_10_1 = Gedcom("test_example_16_1")
        ...
        test_case_10_2 = Gedcom("test_example_16_2")
